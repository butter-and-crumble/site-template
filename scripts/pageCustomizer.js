...
const dashboard = require('./dashboardModule.js')
...
if(!path.startsWith('/cart') || !path.startsWith('/dashboard')){
...
},{"./cartRemovalModule.js":3,"./dashboardModule.js":4,"./productModifierModule.js":16}],2:[function(require,module,exports){
...
function storeProductModifiers(itemID){
    ...
    itemModifiers[itemID] = productModifier
...
function removeProductModifier(itemID){
    itemModifiers = JSON.parse(window.localStorage.getItem('itemModifiers'))
    console.log(itemID)
    console.log('Old... ', itemModifiers)

    if (itemID in itemModifiers) {
        delete itemModifiers[itemID]
        console.log("Delete Mods")
        console.log('New... ', itemModifiers)
    }
    ...
    listenForXHR(item) {
        ...
        function onReadyStateChangeReplacement() {
            if(
                ...
                itemID = this._url.replace(entriesURL,'')
                removeProductModifier(itemID)
            }
...
module.exports = {
    init(){
        ...
        .set('Authorization', 'Bearer 200f1ecf-3c34-4673-bd37-adf8542b67fa')
...
},{"cors":6,"superagent":10}],5:[function(require,module,exports){
...
},{"object-assign":8,"vary":15}],7:[function(require,module,exports){
...
},{"./agent-base":9,"./is-object":11,"./request-base":12,"./response-base":13,"component-emitter":5,"fast-safe-stringify":7}],11:[function(require,module,exports){
"use strict";
